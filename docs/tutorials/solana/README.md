...
Learn how to create a token with the default program, deploy a vesting program, and vest the token in [your deployed program](/tutorials/solana/creating-a-token-and-vesting-the-token-in-your-program).