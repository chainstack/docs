...
Interact with your Ethereum node using <a href="https://github.com/ethereum/go-ethereum/wiki/geth" rel="nofollow">Geth</a>.

1. Install <a href="https://github.com/ethereum/go-ethereum" rel="nofollow">Geth</a>.
...
3. Invoke any methods from <a href="https://github.com/ethereum/wiki/wiki/JavaScript-API" rel="nofollow">Web3 JavaScript API</a>.
...
You can set your <a href="https://metamask.io/" rel="nofollow">MetaMask</a> to interact through your Ethereum nodes deployed with Chainstack.
...
Configure <a href="https://truffleframework.com" rel="nofollow">Truffle Suite</a> to deploy contracts to your Ethereum nodes.

1. Install <a href="https://truffleframework.com" rel="nofollow">Truffle Suite</a>, <a href="https://github.com/trufflesuite/truffle/tree/develop/packages/hdwallet-provider" rel="nofollow">HD Wallet-enabled Web3 provider</a>, and create a project.

2. Create a new environment in `truffle-config.js`, add your mnemonic phrase generated by <a href="https://docs.ethhub.io/using-ethereum/wallets/intro-to-ethereum-wallets/" rel="nofollow">a wallet</a> and the node RPC endpoint:
...
Configure <a href="https://embark.status.im" rel="nofollow">Embark</a> to deploy contracts to your Ethereum nodes.

1. Install <a href="https://embark.status.im" rel="nofollow">Embark</a> and create a project.

2. Create a new environment in `config/contracts.js`, add your mnemonic phrase generated by <a href="https://docs.ethhub.io/using-ethereum/wallets/intro-to-ethereum-wallets/" rel="nofollow">a wallet</a> and the node RPC endpoint:
...
1. Get <a href="https://metamask.io/" rel="nofollow">MetaMask</a> and set it to interact through a Chainstack node. See [Interacting through MetaMask](#metamask).
...
Build DApps using <a href="https://github.com/ethereum/web3.js/" rel="nofollow">web3.js</a> and Ethereum nodes deployed with Chainstack.

1. Install <a href="https://web3js.readthedocs.io/" rel="nofollow">web3.js</a>.
