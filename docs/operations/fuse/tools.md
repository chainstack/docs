...
meta:
  - name: description
    content: Learn how to interact with your Fuse node, deploy smart contracts through your node, and develop dapps.
  - name: keywords
    content: fuse web3 dapp nethermind spark tooling
---
...
Configure [Truffle Suite](https://truffleframework.com) to deploy contracts to your Fuse nodes.
...
Build DApps using [web3.js](https://github.com/ethereum/web3.js/) and Fuse nodes deployed with Chainstack.
...
Build DApps using [web3.py](https://github.com/ethereum/web3.py) and Fuse nodes deployed with Chainstack.
...
Build DApps using [web3.php](https://github.com/web3p/web3.php) and Fuse nodes deployed with Chainstack.
...
Build DApps using [ethers.js](https://github.com/ethers-io/ethers.js/) and Fuse nodes deployed with Chainstack.
...
const provider = new ethers.providers.WebSocketProvider('wss://user-name:pass-word-pass-word-pass-word@ws-nd-123-456-789.p2pify.com', 100);
...
``` sh
brownie networks add Fuse fuse-mainnet name="Mainnet (Chainstack)" host=https://nd-123-456-789.p2pify.com/3c6e0b8a9c15224a8228b9a98ca1531d chainid=100
```
...
``` sh
brownie networks add Fuse fuse-mainnet name="Mainnet (Chainstack)" host=https://user-name:pass-word-pass-word-pass-word@nd-123-456-789.p2pify.com chainid=100
```
...
* [Simple soulbound token with Remix and OpenZeppelin](/tutorials/fuse/simple-soulbound-token-with-remix-and-openzeppelin)
