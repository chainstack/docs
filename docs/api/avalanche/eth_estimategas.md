...
meta:
  - name: description
    content: eth_estimateGas JSON-RPC method for the Avalanche API available with examples in web3.js, web3.py, eth.rb, and cURL.
  - name: keywords
...
web3.eth.estimateGas({
        from: "0x3DD87411a3754deea8cc52C4CF57E2fC254924Cc",
...
print(web3.eth.estimate_gas({"from":"0x3DD87411a3754deea8cc52C4CF57E2fC254924Cc","to":"0x90335eE2286315185a0ff7108B5f7809ce6332F9"}, "latest" ))  
```
...
response = client.eth_estimate_gas({"from":"0x3DD87411a3754deea8cc52C4CF57E2fC254924Cc","to":"0xbe0eb53f46cd790cd13851d5eff43d12404d33e8"}, "latest")
puts response
```
...
curl -X POST "CHAINSTACK_NODE_URL" \
  ...
  --data '{"method":"eth_estimateGas","params":[{"from":"0x3DD87411a3754deea8cc52C4CF57E2fC254924Cc","to":"0xbe0eb53f46cd790cd13851d5eff43d12404d33e8"}, "0xEA8DC5"],"id":1,"jsonrpc":"2.0"}'
```
