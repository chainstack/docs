...
meta:
  - name: description
    content: eth_call JSON-RPC method for the Avalanche API available with examples in web3.js, web3.py, eth.rb, and cURL.
  - name: keywords
    content: json rpc methods curl api web3.py web3.js eth.rb javascript python ruby Avalanche 
---

# Avalanche eth_call RPC method

Avalanche API method that executes a new message call immediately without creating a transaction on the blockchain. 
...
The examples below call the `balanceOf` function of the [Chainlink token](https://snowtrace.io/address/0x5947BB275c521040051D82396192181b413227A3) for the [Chainlink  VRF coordinator](https://snowtrace.io/address/0xd5D517aBE5cF79B7e95eC98dB0f0277788aFF634) address at the latest block.
...
web3.eth.call({
  ...
  data: "0x70a08231000000000000000000000000d5D517aBE5cF79B7e95eC98dB0f0277788aFF634"
})
.then(result => {
...
balance = contract.functions.balanceOf("0xd5D517aBE5cF79B7e95eC98dB0f0277788aFF634").call(block_identifier = "latest")  
...
chainlink_address = "0x5947BB275c521040051D82396192181b413227A3"
...
response = client.call(chainlink_contract, "balanceOf", "0xd5D517aBE5cF79B7e95eC98dB0f0277788aFF634")
puts response
```
...
curl -X POST "CHAINSTACK_NODE_URL" \
  ...
  --data '{"method":"eth_call","params":[{"from":null,"to":"0x5947BB275c521040051D82396192181b413227A3","data":"0x70a08231000000000000000000000000d5D517aBE5cF79B7e95eC98dB0f0277788aFF634"}, "latest"],"id":1,"jsonrpc":"2.0"}'
```
