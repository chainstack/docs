...
meta:
  - name: description
    content: eth_getTransactionReceipt JSON-RPC method for the Avalanche API available with examples in web3.js, web3.py, eth.rb, and cURL.
  - name: keywords
    content: json rpc methods curl api web3.py web3.js eth.rb javascript python ruby Avalanche 
---

# Avalanche eth_getTransactionReceipt RPC method

Avalanche API method that returns a receipt object given a transaction hash.   
...
web3.eth.getTransactionReceipt("0x0d1ff8351965be35df7af58df3308c4da5b23cf9bae6cee1ed458bbcd8ddd38d", (err, receipt) => {
  console.log(receipt)
})
```
...
print(web3.eth.get_transaction_receipt("0x0d1ff8351965be35df7af58df3308c4da5b23cf9bae6cee1ed458bbcd8ddd38d"))  
```
...
response = client.eth_get_transaction_receipt("0x0d1ff8351965be35df7af58df3308c4da5b23cf9bae6cee1ed458bbcd8ddd38d")
