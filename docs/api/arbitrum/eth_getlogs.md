...
meta:
  - name: description
    content: eth_getLogs JSON-RPC method for the Arbitrum API available with examples in web3.js, web3.py, eth.rb, and cURL.
  - name: keywords
    content: json rpc methods curl api web3.py web3.js eth.rb javascript python ruby Arbitrum 
---

# Arbitrum eth_getLogs RPC method

Arbitrum API method that returns an array of all logs matching a given filter object.
...
web3.eth.getPastLogs("0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", (err, logs) => {
  console.log(logs)
})
```
...
response = client.eth_get_logs({address: "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1"})
...
curl -X POST "CHAINSTACK_NODE_URL" \
  ...
  --data '{"method":"eth_getLogs","params":[{"address": "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1"}],"id":1,"jsonrpc":"2.0"}'
```
