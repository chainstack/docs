...
meta:
  - name: description
    content: eth_call JSON-RPC method for the Polygon API available with examples in web3.js, web3.py, eth.rb, and cURL.
  - name: keywords
    content: json rpc methods curl api web3.py web3.js eth.rb javascript python ruby polygon 
---

# Polygon eth_call RPC method RPC method

Polygon API method that executes a new message call immediately without creating a transaction on the blockchain. 
...
The examples below call the `balanceOf` function of the [Chainlink token](https://polygonscan.com/address/0xb0897686c545045afc77cf20ec7a532e3120e0f1) for the [Chainlink  VRF coordinator](https://polygonscan.com/address/0xAE975071Be8F8eE67addBC1A82488F1C24858067) address at the latest block.
...
web3.eth.call({
        to: "0xb0897686c545045afc77cf20ec7a532e3120e0f1",
        data: "0x70a08231000000000000000000000000AE975071Be8F8eE67addBC1A82488F1C24858067"
    })
    .then(result => {
...
balance = contract.functions.balanceOf("0xAE975071Be8F8eE67addBC1A82488F1C24858067").call(block_identifier = "latest")  
...
chainlink_address = "0xb0897686c545045aFc77CF20eC7A532E3120E0F1"
...
response = client.call(chainlink_contract, "balanceOf", "0xAE975071Be8F8eE67addBC1A82488F1C24858067")
puts response
```
...
curl -X POST "CHAINSTACK_NODE_URL" \
  ...
  --data '{"method":"eth_call","params":[{"from":null,"to":"0xb0897686c545045afc77cf20ec7a532e3120e0f1","data":"0x70a08231000000000000000000000000AE975071Be8F8eE67addBC1A82488F1C24858067"}, "latest"],"id":1,"jsonrpc":"2.0"}'
```
