...
meta:
  - name: description
    content: eth_getBlockByHash JSON-RPC method for the Polygon API available with examples in web3.js, web3.py, eth.rb, and cURL.
  - name: keywords
    content: json rpc methods curl api web3.py web3.js eth.rb javascript python ruby polygon
---

# Polygon eth_getBlockByHash RPC method

Polygon API method that returns information about the block matching the given block hash.
...
response = client.eth_get_block_by_hash("0x7709b7cacb9a3d647afe557d51891c00ad0c00e01d5bffdbcfe6c1730d36290c",false)
...
curl -X POST "CHAINSTACK_NODE_URL" \
  ...
  --data '{"method":"eth_getBlockByHash","params":["0x7709b7cacb9a3d647afe557d51891c00ad0c00e01d5bffdbcfe6c1730d36290c",false],"id":1,"jsonrpc":"2.0"}'
```
